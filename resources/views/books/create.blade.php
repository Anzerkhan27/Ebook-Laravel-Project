                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input  class="form-control" type="text" name="title" id="title" class=" p-2 bg-gray-200 @error('title') is-invalid @enderror" />
...
@enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input  class="form-control" type="text" name="author" id="author" class=" p-2 bg-gray-200 @error('author') is-invalid @enderror" ></input>
                      @error('author')
...
@enderror
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control"  name="description" id="description" row="5" class=" p-2 bg-gray-200 @error('description') is-invalid @enderror"></textarea>
